...
class Task(models.Model):
    ...
    employer = models.ForeignKey(USER_MODEL, on_delete=models.CASCADE, null=True)
    ...
    def get_absolute_url(self):
        return reverse('tasks:detail', kwargs={'category_slug': self.categories.slug, 'slug': self.slug})
